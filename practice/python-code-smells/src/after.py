...
# from string import * # Bad practice use explicit imports no *


"""
Code smells are not bugs, they are not errors.
But a technical dept that could cause errors later as more code is added.
"""
...
if __name__ == "__main__":
    ...
    vehicle2 = registry.register_vehicle("Tesla", "Model Y")

    # print out the vehicle information
    print(vehicle.to_string())
    print(vehicle2.to_string())
